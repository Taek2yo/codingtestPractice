...
function solution(arr1,arr2){
    ...
    for (let i= 0; i<arr1.length ; i++){    // for문 이용 arr1의 길이만큼 반복
        if(arr2[i]>=29){                    // 조건, 새벽5시(=29시)가 넘어가면 자동 21시로 선언
            arr2[i] = 21
        }
        study += arr2[i] - arr1[i]         // 체크아웃 시간 - 체크인 시간 => 공부시간
    }
    return study
}
console.log(solution([9,9,9,9,7,9,8],
